    ...
    def train(self):
        ...
        for epoch in range(epoch_done, self.opt.training.epochs):
            for i, batch in enumerate(self.train_loader):
                ...
                # §§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§ cGAN concatenated with one hot feature map §§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§
                
                one_hot_enc_fea_img_whole_batch_fake = []
                for b in range(fake_lbs.shape[0]): # for each batch
                    one_hot_enc = torch.nn.functional.one_hot(fake_lbs[b], 80)
                    one_hot_enc = torch.transpose(fake_lbs[0][None,:], 0,1)
                    #one_hot_enc_fea_img = []
                    for c in range(one_hot_enc.shape[0]): # for each char
                        one_hot_enc_fea_img_char = torch.swapaxes(torch.tile(one_hot_enc[c], (32,64,1)), 0,2)
                        one_hot_enc_fea_img.append(one_hot_enc_fea_img_char)
                    one_hot_enc_fea_img = torch.cat(one_hot_enc_fea_img, dim=2) # one sample ok
                    one_hot_enc_fea_img_whole_batch_fake.append(one_hot_enc_fea_img[None,:,:,:])
                one_hot_enc_fea_img_whole_batch_fake = torch.cat(one_hot_enc_fea_img_whole_batch_fake, dim=0)

                one_hot_enc_fea_img_whole_batch_real = []
                for b in range(real_lbs.shape[0]): # for each batch
                    one_hot_enc = torch.nn.functional.one_hot(real_lbs[b], 80)
                    one_hot_enc = torch.transpose(real_lbs[0][None,:], 0,1)
                    #one_hot_enc_fea_img = []
                    for c in range(one_hot_enc.shape[0]): # for each char
                        one_hot_enc_fea_img_char = torch.swapaxes(torch.tile(one_hot_enc[c], (32,64,1)), 0,2)
                        one_hot_enc_fea_img.append(one_hot_enc_fea_img_char)
                    one_hot_enc_fea_img = torch.cat(one_hot_enc_fea_img, dim=2) # one sample ok
                    one_hot_enc_fea_img_whole_batch_real.append(one_hot_enc_fea_img[None,:,:,:])
                one_hot_enc_fea_img_whole_batch_real = torch.cat(one_hot_enc_fea_img_whole_batch_real, dim=0)
                
                # §§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§
                        
                
                fake_disc = self.models.D(torch.cat([cat_fake_imgs, torch.cat([one_hot_enc_fea_img_whole_batch_fake, one_hot_enc_fea_img_whole_batch_fake, one_hot_enc_fea_img_whole_batch_real])], dim=1).detach(), cat_fake_img_lens, cat_fake_lb_lens)
                ...
                real_disc = self.models.D(torch.cat([real_imgs, one_hot_enc_fea_img_whole_batch_real], dim=1), real_img_lens, real_lb_lens)
                # real_disc_aug = self.models.D(real_aug_imgs, real_aug_img_lens, real_lb_lens)
                # real_disc_aug = self.models.D(torch.cat([real_aug_imgs, one_hot_enc_fea_img_whole_batch_real], dim=1), real_aug_img_lens, real_lb_lens)
                ...
                real_disc_loss = (torch.mean(F.relu(1.0 - real_disc))) # cannot compute one hot enc because of unknown segmentation
                ...
                if iter_count % self.opt.training.num_critic_train == 0:
                    ...
                    cat_fake_imgs = torch.cat([fake_imgs, style_imgs, recn_imgs], dim=0)
                    cat_fake_lb_lens = torch.cat([fake_lb_lens, fake_lb_lens, real_lb_lens], dim=0)
                    cat_fake_disc = self.models.D(torch.cat([cat_fake_imgs, torch.cat([one_hot_enc_fea_img_whole_batch_fake, one_hot_enc_fea_img_whole_batch_fake, one_hot_enc_fea_img_whole_batch_real])], dim=1),
